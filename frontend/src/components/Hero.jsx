    ...
    <div className="relative">
      ...
      <div className="absolute inset-0 flex flex-col items-center md:items-start justify-end md:justify-center pb-24 md:pb-0 md:pl-18 lg:pl-24">
        ...
        <div className="flex items-center mt-6 font-medium gap-6 ">
          <Link
            to={"/products"}
            className="flex bg-orange-600 group items-center gap-2 px-7 rounded text-white  py-3 bg-primary"
          >
            Shop Now
            <img
          ...
          <Link
            to={"/products"}
            className="hidden md:flex group bg-orange-600 items-center gap-2 px-7 rounded text-white  py-3 bg-primary"
          >
            Explore Deals
            <img
              src={assets.white_arrow_icon}
